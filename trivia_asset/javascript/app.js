...
$(document).ready(function() {
	...
	var quiz = [{
		...
		image: "trivia_asset/images/image2.gif"
		}, {
		...
		image: "trivia_asset/images/image1.gif"
		}, {
		...
		image: "trivia_asset/images/image4.gif"
		}, {
		...
		correctAnswer: "Cat",
		image: "trivia_asset/images/image5.gif"
		}, {
		...
		correctAnswer: "Snape",
		image: "trivia_asset/images/image6.gif"
		}];
	...
	function reset() {
		...
		if (index < (quiz.length - 1)) {
			...
			if (correctQuestions != 5){
				$("#correct").html("Correct Answers: " + correctQuestions + ", you can't proceed, try again!");
			}
			else{
				$("#correct").html("Correct Answers: " + correctQuestions + ", you can proceed now");
			}
